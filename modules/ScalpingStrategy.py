...
class ScalpingStrategy:
    ...
    def calculate_indicators(self, df):
        ...
        def calculate_ssl(row):
            ...
            if row['close'] < row['lowerk']:
                return -1  # Red
            if  row['close'] < row['upperk'] & row['close'] > row['lowerk']:
                return 0  # Grey
    ...
    def evaluate_conditions(self, df):
        ...
        last_3_ssl = df['SSL'].iloc[-(2+1):-1].tolist()
        
        print("=========================================================================")
        print(f"last_3_ssl = {last_3_ssl}")
        print(f"last_row['SSL'] = {last_row['SSL']}")
        print(f"last_row['VOLUME_MA'] = {last_row['VOLUME_MA']}")
        print(f"last_row['volume'] = {last_row['volume']}")
        ...
        buy_condition_1 = any(x == 0 for x in last_3_ssl)
        ...
        sell_condition_1 = any(x == 0 for x in last_3_ssl)
